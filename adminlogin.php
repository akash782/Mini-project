...
if(isset($_POST['register'])){
    ...
    $sql="select * from `admin` where `name`='$uname' && `password`='$password' limit 1";
...
<body>
    <div class="container">
        <span>HM&nbsp;|&nbsp;Admin&nbsp;Login</span>
        <div class="form">
           <form action="#" method="POST">
           <fieldset style="padding-bottom: 35px; margin-top: -20px;">
<legend style="padding: 0px 10px;  text-align: center;font:20px 'Roboto',sans-serif;font-weight: bolder;color: rgba(52, 73, 94,1);">Welcome</legend>
